...
//    self.layer.shadowPath = [UIBezierPath bezierPathWithRect:self.bounds].CGPath;
    ...
    _portImageView = [[GHImageView alloc] initWithFrame:CGRectMake(SRCM.left, SRCM.top, IMAGEVIEW_WIDTH, IMAGEVIEW_HEIGHT) defaultImage:@"chat_person_cell_default.png"];
