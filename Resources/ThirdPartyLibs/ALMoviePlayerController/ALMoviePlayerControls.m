...
//        if ([[UIDevice currentDevice].systemVersion floatValue] < 7)
        ...
        _barHeight = [[UIDevice currentDevice].systemVersion floatValue] >= 7.0 ? 70.f : 50.f;
...
- (void)movieFinished:(NSNotification *)note {
    ...
    if (_delegate && [_delegate respondsToSelector:@selector(moviePlayFinished)]) {
        [_delegate moviePlayFinished];
    }
}
